...
import 'file:///C:/Users/momen/AndroidStudioProjects/ratemyday/lib/login/raised_gradient_button.dart';

import 'color_utils.dart';
import '../login/common_style.dart';
...
class _LoginFormWidgetState extends State<LoginFormWidget> {
  ...
  var _userEmailController = TextEditingController(text: "xyz@example.com");
  var _userPasswordController = TextEditingController(text: "xyz@123");
    ...
    return Padding(
      ...
      child: Row(
        children: <Widget>[
          ...
          __buildGmailButtonWidget(context),
  ...
  Widget __buildGmailButtonWidget(BuildContext context) {
    return Expanded(
      flex: 1,
      child: Padding(
